        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedOptionId != -1) {
                    ...
                    if (selectedOptionText.equals("To set the layout file for the activity")) {
                        int duration = Toast.LENGTH_SHORT;
                        Toast.makeText(NinthQuestion.this, "This is the CORRECT answer You Earned $ 75000", duration).show();
                        Intent intent = new Intent(NinthQuestion.this, TenthQuestion.class);
                        startActivity(intent);
                    } else {
                        int duration = Toast.LENGTH_SHORT;
                        Toast.makeText(NinthQuestion.this, "Not Correct", duration).show();
                        Intent intent = new Intent(NinthQuestion.this, Looser.class);
                        startActivity(intent);
                    }
