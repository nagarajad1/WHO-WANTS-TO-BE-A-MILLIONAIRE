        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedOptionId != -1) {
                    ...
                    if (selectedOptionText.equals("ScrollView")) {
                        int duration = Toast.LENGTH_SHORT;
                        Toast.makeText(FourthQuestion.this, "This is the CORRECT answer You Earned $ 15000", duration).show();
                        Intent intent = new Intent(FourthQuestion.this, FifthQuestion.class);
                        startActivity(intent);
                    } else {
                        int duration = Toast.LENGTH_SHORT;
                        Toast.makeText(FourthQuestion.this, "Not Correct", duration).show();
                        Intent intent = new Intent(FourthQuestion.this, Looser.class);
                        startActivity(intent);
                    }
