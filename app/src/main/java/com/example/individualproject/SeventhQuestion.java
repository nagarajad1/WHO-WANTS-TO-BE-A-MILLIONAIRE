        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedOptionId != -1) {
                    ...
                    if (selectedOptionText.equals("SharedPreferences")) {
                        int duration = Toast.LENGTH_SHORT;
                        Toast.makeText(SeventhQuestion.this, "This is the CORRECT answer You Earned $ 50000", duration).show();
                        Intent intent = new Intent(SeventhQuestion.this, EighthQuestion.class);
                        startActivity(intent);
                    } else {
                        int duration = Toast.LENGTH_SHORT;
                        Toast.makeText(SeventhQuestion.this, "Not Correct", duration).show();
                        Intent intent = new Intent(SeventhQuestion.this, Looser.class);
                        startActivity(intent);
                    }
