        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedOptionId != -1) {
                    ...
                    if (selectedOptionText.equals("PermissionDialog")) {
                        int duration = Toast.LENGTH_SHORT;
                        Toast.makeText(TenthQuestion.this, "This is the CORRECT answer You Earned $ 100000", duration).show();
                        SharedPreferences sharedPreferences = getSharedPreferences("MyPreferences", MODE_PRIVATE);
                        SharedPreferences.Editor editor = sharedPreferences.edit();
                        editor.putString("score", "100000");
                        editor.apply();
                        Intent intent = new Intent(TenthQuestion.this, Winner.class);
                        startActivity(intent);
                    } else {
                        int duration = Toast.LENGTH_SHORT;
                        Toast.makeText(TenthQuestion.this, "Not Correct", duration).show();
                        Intent intent = new Intent(TenthQuestion.this, Looser.class);
                        startActivity(intent);
                    }
